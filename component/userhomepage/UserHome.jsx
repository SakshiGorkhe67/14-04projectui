      ...
      <div id="carouselExampleControls" class="carousel slide centered-carousel" data-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item position-relative">
            <img class="d-block w-100" src={homebanner} alt="Second slide" />
            ...
            <Link to="/about">
              <button type="button" class="btn btn-outline-primary carousel-button">SHOP NOW</button>
            </Link>
          </div>
          ...
          {/**slider 2 */}
          <div class="carousel-item position-relative">
            <img class="d-block w-100" src={homebanner1} alt="Second slide" />
            <div class="position-absolute top-50 start-0 translate-middle-y p-3">
              <p style={{ fontFamily: 'sans-serif', color: 'grey' }}>Weekend Deal</p>
